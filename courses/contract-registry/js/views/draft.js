...
function desk(view, ctx, data, tpl) {
  ...
  const form = h('div.w-form',
    ...
    h('fieldset.w-set', h('legend', '2 · Letter header'),
      ...
      hField('yourRefs', 'Their letters (one per line)', 'area', 'LOT-01/SINOHYDRO-KSNS-JV/9001 dated 12 August 2026'),
      hField('ourRefs', 'Our earlier letters (one per line)', 'area', 'TKV/COM/2026/9001 dated 21 July 2026'),
